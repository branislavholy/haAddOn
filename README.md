![version](https://img.shields.io/static/v1?label=version&message=1.4.4&color=blue) <!-- x-release-please-version -->
...
podman build --format docker --pull --rm --build-arg BUILD_FROM="ghcr.io/home-assistant/aarch64-base:latest" -t weather:latest -t 'weather:1.4.4' .
...
<!-- x-release-please-start-version -->
```bash
podman rmi weather:1.4.4 weather:latest
```
<!-- x-release-please-end -->
