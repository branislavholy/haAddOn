...
podman build --format docker --pull --rm --build-arg BUILD_FROM="ghcr.io/home-assistant/aarch64-base:latest" -t weather:latest -t 'weather:1.1.0' .
...
<!-- x-release-please-start-version -->
```bash
podman rmi weather:1.1.0 weather:latest
```
<!-- x-release-please-end -->
