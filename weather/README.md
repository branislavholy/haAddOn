![version](https://img.shields.io/static/v1?label=version&message=1.5.7&color=blue) <!-- x-release-please-version -->
...
podman build --format docker --pull --rm --build-arg BUILD_FROM="ghcr.io/home-assistant/aarch64-base:latest" -t weather:latest -t 'weather:1.5.7' .
...
<!-- x-release-please-start-version -->
```bash
podman rmi weather:1.5.7 weather:latest
```
<!-- x-release-please-end -->
